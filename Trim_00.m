%% Steady straight and level flight, V=90 m/s, altitude=2000m
trim.StickLat =  0;
...
trim.Vb         =  [89.8394959470165  0.0  5.37261277089718]';
...
trim.AttitudeBE =  [0, 0.0597312094600456, 0]'; % roll, pitch, yaw
